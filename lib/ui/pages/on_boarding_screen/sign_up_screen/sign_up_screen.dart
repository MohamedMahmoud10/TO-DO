          ...
          child: Column(children: [
            ...
            Align(
                ...
                child: Text(
                  ...
                  style:
                      bodyStyle.copyWith(letterSpacing: 2, color: Colors.grey),
                )),
            InputField(
              prefixxIcon: Icon(
                Icons.person,
            ...
            InputField(
              ...
              icon:
                  Icon(Icons.remove_red_eye, size: 30, color: Appcolors.purple),
              text: '',
              hintText: 'Password',
            ),
            SizedBox(
            ...
            RoundedContainer(
              ...
              child: Center(
                  child: Text(
                'Sign Up',
                style: bodyStyle.copyWith(color: white, letterSpacing: 1),
              )),
            ),
            SizedBox(
              height: 5,
